            ...
            <form method="POST" action="{{ route("admin.domain-pricings.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('register_price') ? 'is-invalid' : '' }}" type="number"
                           name="register_price" id="register_price" value="{{ old('register_price', '') }}" step="1"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('transfer_price') ? 'is-invalid' : '' }}" type="number"
                           name="transfer_price" id="transfer_price" value="{{ old('transfer_price', '0') }}" step="1"
                           required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('renew_price') ? 'is-invalid' : '' }}" type="number"
                           name="renew_price" id="renew_price" value="{{ old('renew_price', '') }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('grace') ? 'is-invalid' : '' }}" type="number"
                           name="grace" id="grace" value="{{ old('grace', '30') }}" step="1">
                    @if($errors->has('grace'))
                        <div class="invalid-feedback">
                            {{ $errors->first('grace') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('redemption_price') ? 'is-invalid' : '' }}" type="text"
                           name="redemption_price" id="redemption_price" value="{{ old('redemption_price', '') }}"
                           required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status"
                        ...
                        @foreach(App\Models\DomainPricing::STATUS_SELECT as $key => $label)
                            <option
                                value="{{ $key }}" {{ old('status', 'active') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
