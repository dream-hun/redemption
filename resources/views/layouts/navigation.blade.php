            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <x-nav-link :href="route('cart.index')" :active="request()->routeIs('cart.index')" class="me-4">
                    <span class="relative inline-block">
                        ...
                        @if ($cartCount > 0)
                            <span
                                class="absolute top-0 right-0 inline-flex items-center justify-center w-6 h-6 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">{{ Cart::instance('default')->count() }}</span>
                        @endif
                    </span>
